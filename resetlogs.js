...
module.exports = {
    ...
    .setName("resetlogs")
    .setDescription("Reset logs for a user")
    .addUserOption(option => 
        option
        .setName("user")
        .setDescription("The user whose logs you want to reset")
        .setRequired(true)),
    ...
    async execute(interaction) {
        try {
            ...
            if (interaction.member.permissions.has(PermissionsBitField.Flags.ManageRoles)) {
                ...
                .setTitle(`Logs for ${target.username} have been reset`)
                .setColor("Green")
                .addFields(
